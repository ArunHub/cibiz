...
<head>
    <title>Cibiz N2 Natural Nutrition </title>
    <meta charset="utf-8">
   ...
   <!-- murunga-powder -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p><span class="glyphicon glyphicon-tint"></span> Oil that will be heated (for use in cooking) is then bleached by filtering it through fuller's earth, activated carbon, or activated clays that absorb certain pigmented material from the oil. </p>
                    <p><span class="glyphicon glyphicon-tint"></span> Finally, the oil is deodorized. In this process, steam is passed over hot oil in a vacuum at between <strong>440 and 485 degrees Fahrenheit</strong> , thus allowing the volatile taste and odour components to distil from the oil. Typically, citric acid at .01 percent is also added to oil after deodorization to inactivate trace metals that might promote oxidation within the oil and hence shorten its shelf-life.</p>
                ...
                <div class="col-sm-6">
                    ...
                    <p><strong><span class="glyphicon glyphicon-tint"></span> The oil thus retains its original unique aroma, rich flavour & colour and all its nutritional value
							    viz antioxidants, magnesium, copper, calcium, iron, zinc, and vitamin B6, phytosterols, chlorophyll; lecithin etc, all needed for good health.</strong></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="features-grids">
                <div class="col-md-4 features-grid">
                    <div class="features-grid-info">
                        <div class="col-md-12 features-info">
                            <p><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> It helps to bring down blood pressure and level of cholesterol.</p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="features-grid-info">
                        <div class="col-md-12 features-info">
                            <p><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> Helps to keep the body active by flushing out toxins and keeping skin healthy.</p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="features-grid-info">
                        <div class="col-md-12 features-info">
                            <p><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> Helps in oral hygiene through Oil pulling by strengthening jaws and stopping bleeding of gums.</p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="features-grid-info">
                ...
                <div class="col-md-4 features-grid">
                    ...
                    <div class="features-grid-info">
                        <div class="col-md-12 features-info">
                            <p><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> Infused with anti-bacterial and anti-inflammatory properties, this oil speeds up curing skin conditions like psoriasis and eczema.</p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="features-grid-info">
    ...
    <div id="video" class="yellowsection text-center">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/nvqFu575gjk?rel=0" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6">
                    <iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/hpABZarVBHc?rel=0" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-xs-12">
                    <hr>
                </div>
                <div class="col-sm-6">
                    <iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/YwolBBRFOrw?rel=0&start=12" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6">
                    <iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/mTFGgjcKKHI?rel=0&start=12" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="contact" class="getintouch">
        <div class="container">
            ...
            <div class="col-md-8 getintouch-left">
                ...
                $comment .= "<tr><td style='background: #eee;'><strong>Phone Number</strong> </td><td>" .$_REQUEST['tele']. "</td></tr>";
            ...
            <div class="col-md-4 getintouch-left">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2310.843643462468!2d80.20140177051893!3d13.076338701743907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5266a6fe4646f3%3A0xb296c4a0f7ad05b5!2sCibi+Enterprises!5e0!3m2!1sen!2sin!4v1443810641505" width="100%" height="517" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    <div class="footer">
